...
source.include_exts = py,png,jpg,kv,atlas,mp3,ogg,ttf,db

# (list) List of inclusions using pattern matching
#source.include_patterns = assets/*,back.jpg
...
requirements = python3,kivy==1.11.1,kivymd==0.104.1,python-bidi,arabic_reshaper,pyjnius,pysqlite3
