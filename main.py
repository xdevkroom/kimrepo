...
class WhatsappDirct(MDApp):
    def build(self):
        ...
        self.txtin1 = TextInput(size_hint=(.4,.05),hint_text=self.arabic("ادخل رقم الهاتف"),pos_hint={"center_x":.75,"center_y":.575},input_filter="int",font_name="font/arial.ttf")
